...
import com.overarching.sky.lib.utils.AppGlobals;
...
public class QDSkinManager {
    ...
    public static void changeSkin(int index) {
        QMUISkinManager.defaultInstance(AppGlobals.get()).changeSkin(index);
        QDPreferenceManager.getInstance(AppGlobals.get()).setSkinIndex(index);
    }

    public static int getCurrentSkin() {
        return QMUISkinManager.defaultInstance(AppGlobals.get()).getCurrentSkin();
    }
}
